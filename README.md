...
See few metadata below: 
1- for PhytoplanKTON DATA
"ABUNDANCE"	"Number of organisms counted from sample"					
"ALGAL_GROUP"	"Broad algal group, used in metric calculation"	"None"	"CRYPTOPHYTES|CYANOBACTERIA|DIATOM|DINOFLAGELLATES|EUGLENOIDS|EUSTIGMATOPHYTES|GOLDEN ALGAE|GREEN ALGAE|OTHER|UNDETERMINTED| YELLOW-GREEN ALGAE"			
"BIOVOLUME"	"Volume of cells per mL of sample"	"cu um/ml"				
"DATE_COL"	"Date of sample collection"	"None"				
"DENSITY"	"Number of organisms/mL"					
"IS_DISTINCT"	"Distinct taxa classification per sample"		"1|0"			
